...
var empresaRoutes = [
    { path: '', component: __WEBPACK_IMPORTED_MODULE_4__empresa_component__["a" /* EmpresaComponent */], children: [
            { path: '', component: __WEBPACK_IMPORTED_MODULE_8__empresalista_empresalista_component__["a" /* EmpresalistaComponent */] },
            { path: 'lista', component: __WEBPACK_IMPORTED_MODULE_8__empresalista_empresalista_component__["a" /* EmpresalistaComponent */] },
            { path: 'cadastro', component: __WEBPACK_IMPORTED_MODULE_7__empresacadastro_empresacadastro_component__["a" /* EmpresacadastroComponent */] },
            { path: 'funcionario', component: __WEBPACK_IMPORTED_MODULE_6__empresafuncionario_empresafuncionario_component__["a" /* EmpresafuncionarioComponent */] },
            { path: 'servico', component: __WEBPACK_IMPORTED_MODULE_5__empresaservico_empresaservico_component__["a" /* EmpresaservicoComponent */] },
            { path: 'pergunta', component: __WEBPACK_IMPORTED_MODULE_9__empresapergunta_empresapergunta_component__["a" /* EmpresaperguntaComponent */] },
            { path: 'cadastro/:id', component: __WEBPACK_IMPORTED_MODULE_7__empresacadastro_empresacadastro_component__["a" /* EmpresacadastroComponent */] },
        ] },
];
