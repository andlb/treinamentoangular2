...
var oficinaRoutes = [
    { path: '', component: __WEBPACK_IMPORTED_MODULE_5__oficinalist_oficinalist_component__["a" /* OficinalistComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_1__autenticar_guards_auth_guard__["a" /* AuthGuard */]] },
    { path: 'lista', component: __WEBPACK_IMPORTED_MODULE_5__oficinalist_oficinalist_component__["a" /* OficinalistComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_1__autenticar_guards_auth_guard__["a" /* AuthGuard */]] },
    { path: 'lista/:edit', component: __WEBPACK_IMPORTED_MODULE_5__oficinalist_oficinalist_component__["a" /* OficinalistComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_1__autenticar_guards_auth_guard__["a" /* AuthGuard */]] },
    { path: 'cadastro', component: __WEBPACK_IMPORTED_MODULE_4__oficinacadastro_oficinacadastro_component__["a" /* OficinacadastroComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_1__autenticar_guards_auth_guard__["a" /* AuthGuard */]] },
    { path: 'cadastro/:id', component: __WEBPACK_IMPORTED_MODULE_4__oficinacadastro_oficinacadastro_component__["a" /* OficinacadastroComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_1__autenticar_guards_auth_guard__["a" /* AuthGuard */]] },
    { path: 'survey/:id', component: __WEBPACK_IMPORTED_MODULE_6__survey_survey_component__["a" /* SurveyComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_1__autenticar_guards_auth_guard__["a" /* AuthGuard */]] }
];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__cadastro_empresa_empresa_service__ = __webpack_require__("../../../../../src/app/cadastro/empresa/empresa.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_router__ = __webpack_require__("../../../router/@angular/router.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__oficina_service__ = __webpack_require__("../../../../../src/app/oficina/oficina.service.ts");
...
var OficinacadastroComponent = (function () {
    function OficinacadastroComponent(formBuilder, oficinaService, empresaService, route, router, authService) {
        ...
        this.subsPesquisaAtendimento = this.route.params.subscribe(function (params) {
            ...
            if (_this.atendimentoid) {
                ...
                _this.subsPesquisa = _this.oficinaService
                    ...
                    _this.oficinaService.setVeiculo(data.veiculo, data.ordemservico);
                ...
                _this.subEmpresa = _this.empresaService
                    ...
                    if (data.success) {
                        ...
                        _this.servicos = data.servicos;
                        _this.oficinaService.setOrdemservicoid(null);
            ...
            this.subPlaca = this.oficinaService
                ...
                if (data.veiculo && data.proprietario) {
                    ...
                    if (data.proprietario.cadastrado) {
                        _this.cadastrado = data.proprietario.cadastrado;
                    }
                    _this.preencheFormulario();
                    ...
                    _this.onLimpar();
                    _this.form.controls["placa"].setValue(placa);
                }
                _this.processing = false;
            });
        }
    ...
    OficinacadastroComponent.prototype.mudarCpf = function (event) {
        if (!this.edit) {
    ...
    OficinacadastroComponent.prototype.createForm = function () {
        var servicosForm = new __WEBPACK_IMPORTED_MODULE_4__angular_forms__["b" /* FormArray */]([]);
        this.form = this.formBuilder.group({
            placa: [
                "",
                [
                    __WEBPACK_IMPORTED_MODULE_4__angular_forms__["d" /* Validators */].required,
                    __WEBPACK_IMPORTED_MODULE_4__angular_forms__["d" /* Validators */].minLength(8),
                    __WEBPACK_IMPORTED_MODULE_4__angular_forms__["d" /* Validators */].maxLength(8),
                    __WEBPACK_IMPORTED_MODULE_4__angular_forms__["d" /* Validators */].pattern(/[A-Z]{3}-?\d{3}/)
                ]
            ],
            marca: "",
            modelo: "",
            ano: "",
            anomodelo: "",
            cpf: ["", __WEBPACK_IMPORTED_MODULE_4__angular_forms__["d" /* Validators */].required],
            nome: ["", __WEBPACK_IMPORTED_MODULE_4__angular_forms__["d" /* Validators */].required],
            email: [
                "",
                [
                    __WEBPACK_IMPORTED_MODULE_4__angular_forms__["d" /* Validators */].required,
                    __WEBPACK_IMPORTED_MODULE_4__angular_forms__["d" /* Validators */].minLength(5),
                    __WEBPACK_IMPORTED_MODULE_4__angular_forms__["d" /* Validators */].maxLength(30),
                    __WEBPACK_IMPORTED_MODULE_4__angular_forms__["d" /* Validators */].pattern(/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/)
                ]
            ],
            dtnascimento: [
                "",
                [
                    __WEBPACK_IMPORTED_MODULE_4__angular_forms__["d" /* Validators */].required,
                    __WEBPACK_IMPORTED_MODULE_4__angular_forms__["d" /* Validators */].minLength(10),
                    __WEBPACK_IMPORTED_MODULE_4__angular_forms__["d" /* Validators */].maxLength(10),
                    __WEBPACK_IMPORTED_MODULE_4__angular_forms__["d" /* Validators */].pattern(/^(?:(?:31(\/|-|\.)(?:0?[13578]|1[02]))\1|(?:(?:29|30)(\/|-|\.)(?:0?[1,3-9]|1[0-2])\2))(?:(?:1[6-9]|[2-9]\d)?\d{2})$|^(?:29(\/|-|\.)0?2\3(?:(?:(?:1[6-9]|[2-9]\d)?(?:0[48]|[2468][048]|[13579][26])|(?:(?:16|[2468][048]|[3579][26])00))))$|^(?:0?[1-9]|1\d|2[0-8])(\/|-|\.)(?:(?:0?[1-9])|(?:1[0-2]))\4(?:(?:1[6-9]|[2-9]\d)?\d{2})$/)
                ]
            ],
            quilometragem: [
                "",
                [__WEBPACK_IMPORTED_MODULE_4__angular_forms__["d" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_4__angular_forms__["d" /* Validators */].pattern(/^[0-9]*$/)]
            ],
    ...
    OficinacadastroComponent.prototype.enviaDados = function () {
        ...
        for (var _i = 0, _a = this.form.get("servicosForm").controls; _i < _a.length; _i++) {
            ...
            if (control.value.selecionado) {
                var proximadatatroca = "";
                if (control.value.proximatrocadata) {
                    proximadatatroca = __WEBPACK_IMPORTED_MODULE_6_moment__(Date.now()).add(control.value.proximatrocadata, "day");
                }
                var proximatrocakm = "";
    ...
    OficinacadastroComponent.prototype.onFinalizar = function () {
        this.finalizar = true;
        this.enviaDados();
    };
    ...
    OficinacadastroComponent.prototype.adicionarServicoForm = function () {
        if (this.servicos) {
            var _loop_1 = function (tServico) {
                var oServicoRealizado = this_1.servicosRealizados.find(function (servicorealizado) { return servicorealizado.servicoid === tServico._id; });
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__angular_core__["ViewChild"])("placa"),
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__angular_core__["ViewChild"])("quilometragem"),
    __metadata("design:type", typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_5__angular_core__["ElementRef"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__angular_core__["ElementRef"]) === "function" && _b || Object)
...
OficinacadastroComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_4__angular_forms__["c" /* FormBuilder */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__angular_forms__["c" /* FormBuilder */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_3__oficina_service__["a" /* OficinaService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__oficina_service__["a" /* OficinaService */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_1__cadastro_empresa_empresa_service__["a" /* EmpresaService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__cadastro_empresa_empresa_service__["a" /* EmpresaService */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_2__angular_router__["c" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__angular_router__["c" /* ActivatedRoute */]) === "function" && _f || Object, typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_2__angular_router__["a" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__angular_router__["a" /* Router */]) === "function" && _g || Object, typeof (_h = typeof __WEBPACK_IMPORTED_MODULE_0__autenticar_auth_service__["a" /* AuthService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__autenticar_auth_service__["a" /* AuthService */]) === "function" && _h || Object])
...
module.exports = "<div>\r\n  <div class=\"row show-hide-message\">\r\n    <div [ngClass]=\"messageClass\">\r\n      {{message}}\r\n    </div>\r\n  </div>\r\n</div>\r\n<div class='container'>\r\n  <h3 class=\"page-header\"> {{edit ? 'Cadastro de serviços':'Serviços em aberto para avaliação'}}</h3>\r\n  <a *ngIf=\"edit\" class=\"btn btn-success\" (click)='onNovo()'>Novo</a>\r\n  <table class=\"table table-striped table-hover \">\r\n    <thead>\r\n      <tr>\r\n        <th>#</th>\r\n        <th>Placa</th>\r\n        <th>Proprietário</th>\r\n      </tr>\r\n    </thead>\r\n    <tbody>\r\n      <tr *ngFor=\"let ordemservico of ordemservicos; let i = index\" style=\"cursor: pointer\" (click)=\"onEditItem(ordemservico._id)\">\r\n        <td>{{i}}</td>\r\n        <td>{{ordemservico.veiculoid.placa}}</td>\r\n        <td>{{ordemservico.usuarioid.nome}}</td>\r\n      </tr>\r\n    </tbody>\r\n  </table>\r\n</div>\r\n"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_router__ = __webpack_require__("../../../router/@angular/router.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__autenticar_auth_service__ = __webpack_require__("../../../../../src/app/autenticar/auth.service.ts");
...
var OficinalistComponent = (function () {
    function OficinalistComponent(oficinaService, authService, route, router) {
        this.oficinaService = oficinaService;
        this.authService = authService;
        this.route = route;
        this.router = router;
...
OficinalistComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_0__oficina_service__["a" /* OficinaService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__oficina_service__["a" /* OficinaService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_3__autenticar_auth_service__["a" /* AuthService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__autenticar_auth_service__["a" /* AuthService */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__angular_router__["c" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__angular_router__["c" /* ActivatedRoute */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_2__angular_router__["a" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__angular_router__["a" /* Router */]) === "function" && _d || Object])
